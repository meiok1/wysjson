...
JSONOKOK 是一个为 VS Code 设计的嵌套 JSON 表格编辑器扩展。该项目允许用户通过直观的表格界面编辑 JavaScript 对象和数组数据，支持多种编程语言和文件类型。
...
JSONOKOK 是一个功能完整、架构清晰的 VS Code 扩展。其设计特点包括：
