...
## 简介
本指南面向 JSONOKOK VS Code 扩展的构建与发布流程，涵盖以下主题：
...
## 结论
本指南系统梳理了 JSONOKOK 的构建与部署流程：从 TypeScript 编译、Webview 资源转换，到解析器与中间模型的设计，再到本地测试、VSIX 打包与 GitHub Pages 自动化部署。遵循上述步骤与最佳实践，可高效完成开发、测试与发布的闭环。
